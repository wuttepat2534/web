            ...
            while($row = $promotion_tb1->fetch(PDO::FETCH_ASSOC))
            {
              ...
              if ($q_1->rowCount() > 0 && $row["p_transfer_type"] != "3") //เคยรับโปรนี้ไปแล้ว
              {
                ...
                else if($row["p_transfer_type"] == "2") //โปรครั้งแรกของวัน
                {
                  ...
                  <div class="row boxpro">
                    ...
                    <div class="col-sm-6" style="border-bottom:1px solid #252525!important; margin-bottom: 20px;">
                      ...
                      if(!empty(get_session()))
                      {
                        ...
                        {
                        ?>
                        <button style="background-color: #e4c068; margin-bottom: 10px;" onClick="loadingPage(); get_bonus(<?=$row['p_id']?>);" class="btn btn-lg btn-dark-green hvr-buzz ml-0">
              ...
              ?>
               <div class="row boxpro">
                ...
                <div class=" " style="border-bottom:1px solid #252525!important; margin-bottom: 20px;"><img style="width: 100%;" src="<?=$row['p_img']?>">
                  <h2 style="font-weight: bold; margin-top: 5px; color: #e5af4b;"><?=$row['p_title']?></h2>
                  <p style="color:#FFFFFF;">
