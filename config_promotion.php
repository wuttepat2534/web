            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <span><strong>ประเภทโบนัส : </strong><?php if($row['p_transfer_type'] == "1"){echo "ย้ายเงินครั้งแรก";}elseif($row['p_transfer_type'] == "2"){echo "ย้ายเงินครั้งแรกของวัน";}elseif($row['p_transfer_type'] == "3"){echo "รับได้ตลอด";}elseif($row['p_transfer_type'] == "4"){echo "ฟรีเครดิต";}?></span>
                  </div>
                  <div class="col-sm-12">
