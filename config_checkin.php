            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="row">
                  ...
                  ?>
                  <div class="col-sm-12">
                    <button type="button" onclick="open_modal_edit('<?=$row['c_id']?>', '<?=$row['c_reward']?>', '<?=$row['c_turnover']?>', '<?=$row['c_withdraw_max']?>', '<?=$row['c_target_topup']?>', '<?=$row['c_status']?>', '<?=$row['c_day']?>')" class="btn btn-success btn-block">
...
<script type="text/javascript">
  function open_modal_edit(c_id, c_reward, c_turnover, c_withdraw_max, c_target_topup, c_status, c_day)
  {
    $("#sp_c_day").html(c_day);
