            ...
            <tbody>
              ...
              <tr>
               ...
               <td width="50%" style="text-align: right;">
                  ...
                  <br>
                  <span id="credit_total_balance" style="color:#ecc568; font-size: 35px;"><?=get_wallet("u_wallet")?>บาท</span>  </td>
            </tr>
         </tbody></table>
		 ...
		 <table width="100%">
            <tbody><tr>
              ...
              <a class="u-btn btn-play btn-block hvr-buzz" style="cursor: pointer; " href="<?=base_url()?>/gambling" onClick="loadingPage();">
                <div class="tt_l tt_full b_link_game" style="background: linear-gradient(to bottom, #dbc500 0%, #d49500 44%, #c46300 100%);">
