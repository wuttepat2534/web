      ...
      <div class="tt_l tt_full tt_content bg">
        <div class="tt_l tt_full">
          <div class="tt_l tt_full gr_btn" style="border-bottom: 2px solid rgb(253 162 49);padding-bottom: 20px;">
            <div class="grup_b grup_b1 blobgame bluegame active" style="animation: transitionIn 0.10s;">
              <img src="<?=base_url()?>/images/g_menu/g_menu1.png"/><span>ทั้งหมด</span>
            </div>
            <div class="grup_b grup_b2 blobgame bluegame" style="animation: transitionIn 0.10s;">
              <img src="<?=base_url()?>/images/g_menu/g_menu2.png"/><span>คาสิโน ออนไลน์</span>
            </div>
            <div class="grup_b grup_b3 blobgame bluegame" style="animation: transitionIn 0.20s;">
              <img src="<?=base_url()?>/images/g_menu/g_menu3.png"/><span>สล๊อต ออนไลน์</span>
            </div>
            <div class="grup_b grup_b4 blobgame bluegame" style="animation: transitionIn 0.30s;">
              <img src="<?=base_url()?>/images/g_menu/g_menu4.png"/><span>เกมยิงปลา ออนไลน์</span>
            </div>
            <div class="grup_b grup_b5 blobgame bluegame" style="animation: transitionIn 0.40s;">
              <img src="<?=base_url()?>/images/g_menu/g_menu5.png"/><span>เกมไพ่</span>
            </div>
            <div class="grup_b grup_b6 blobgame bluegame" style="animation: transitionIn 0.50s;">
          ...
          <div class="tt_l tt_full gp1 active">
            <div class="row">
              ...
              {
              ?>
              <div class="tt_l tt_col_4x post-gslot " style="border: 0px;" data-aos="zoom-in-down">
