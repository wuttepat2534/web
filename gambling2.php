...
<head>
  ...
  <link rel="stylesheet" href="themes/story/style.css">
...
<body data-rsssl=1 class="home blog">
  ...
  <div class="wrapper">
    <div class="tt_l tt_full p_gl">
      ...
      <?php include("themes/story.php"); ?>
        <div class="tt_l tt_full">
          <div class="tt_l tt_full gr_btn" style="border-bottom: 2px solid rgb(253 162 49);padding-bottom: 20px; padding-top: 20px;">
...
<div id="modal01" class="w3-modal" onclick="this.style.display='none'">
  <span class="w3-button w3-hover-red w3-xlarge w3-display-topright">ปิด</span>
  <div class="w3-modal-content w3-animate-zoom">
    <img id="img01" class="center">
  </div>
</div>
<!-- The Modal story -->
  <!-- footer -->
