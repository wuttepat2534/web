          ...
          <div class="tt_l tt_full fr_login">
            <div class="fr_center">
              ...
              <div class="tt_l tt_full deposit-head">
                <h2 class="mt-2">บัญชีธนาคารสำหรับฝากเงิน</h2>
              </div>
              ...
              ?>
              	  <div class="tt_l tt_full deposit-head">
                <h3 class="pt-1">ฝากเงินไม่มีขั้นต่ำ</h3>
				<h3 class="pt-1" style="background-color: #ff6a00;"> ธนาคารจะไม่ออโต้ ช่วงเวลา 23:00 - 00:00 น. ให้ลูกค้า แจ้งสลิปพร้อมเบอร์ได้เลยค่ะ</h3>
              </div>
                <div class="tt_l tt_full deposit-head">
                  <h3 class="pt-1">ฝากเงินแบบออโต้</h3>
                </div>
                <div class="bank-box <?=$row['a_bank_code']?>-box">
                  <img style="width: 250px;" src="./themes/v2/images/<?=$row['a_bank_code']?>-logo.png">
                </div>
              ...
              <div class="user-bank-info">
                ...
                <table width="100%" border="0" align="center" cellpadding="10" class="tablea">
                  <tr class="tr-table">
                    <td><div align="center" class="style1">ธนาคาร</div></td>
                    <td><div align="center" class="style1">ชื่อบัญชี</div></td>
                    <td><div align="center" class="style1">เลขบัญชี</div></td>
                  </tr>
                  <tr class="tdd">
                    <td><div align="center" class="listbank">
                      <?=get_wallet("u_bank_name")?>
                    </div></td>
                    <td><div align="center" class="listbank">
                      <?=get_wallet("u_fname")?>
                    </div></td>
                    <td><div align="center" class="listbank">
                      <?=get_wallet("u_bank_number")?>
                    </div></td>
                  </tr>
                </table>
              </div>
